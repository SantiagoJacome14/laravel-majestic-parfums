      ...
      <div style={{ display: "grid", gap: 16 }}>
        <div style={{ background: "#fff", border: "1px solid #eee", borderRadius: 16, padding: 18 }}>
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 14, flexWrap: "wrap" }}>
            <Link href="/catalog" style={{ padding: "10px 14px", borderRadius: 12, border: "1px solid #111", background: "#111", color: "#fff", textDecoration: "none" }}>
              Ver catálogo
            </Link>
            <Link href="/how-to-buy" style={{ padding: "10px 14px", borderRadius: 12, border: "1px solid #eee", background: "#fff", textDecoration: "none" }}>
              Cómo comprar
            </Link>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 }}>
          {[
            ...
            { title: "Envíos", text: "Te compartimos guía y seguimiento." },
          ].map((c) => (
            <div key={c.title} style={{ background: "#fff", border: "1px solid #eee", borderRadius: 16, padding: 16 }}>
